# -*- coding: utf-8 -*-
"""GCN_EventPredictor_(Training).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Zl_fW7Odb4H25rXLrza6d4ymmrIVVDKj
...
for lr_run in range(3):
  ...
  for run in range(num_runs):
    ...
    torch.save(model.state_dict(),'{}/EventPredictor_parameters_{}_{}_{}_run{}_GCNNNNNNNNN.pt'.format(save_folder,dataset,variant,lr_value,run))
