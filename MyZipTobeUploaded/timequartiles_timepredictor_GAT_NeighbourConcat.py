# -*- coding: utf-8 -*-
"""TimeQuartiles_TimePredictor_(GCN).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1dCbBdvOXNKGa3L5gRIs1oCKNJiMjSQwj

<a href="https://colab.research.google.com/github/ishwarvenugopal/GCN-ProcessPrediction/blob/master/Evaluate_Models/Time_Quartiles/TimeQuartiles_TimePredictor_(GCN).ipynb" target="_parent"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a>
...
for lr_run in range(lr_run, lr_run_end):
  ...
  for run in range(num_runs):
    model.load_state_dict(torch.load('D:\\GraphAnalytics\\GCN-ProcessPrediction-master\\python_files\\Results\\helpdesk\\TimestampPredictor_parameters_helpdesk_weighted_0.001_run0_better.pt'))
...
df.to_csv('TimeQuartiles_MAE_{}_{}.csv'.format(dataset,variant),index=False)
df
