...
Original file is located at
    https://colab.research.google.com/drive/19DwsdAQ12vF1XSuKfObz5A1RmfcNmQZU
...
for lr_run in range(lr_run, lr_run_end):
  ...
  for run in range(num_runs):
    model.load_state_dict(torch.load('{}/EventPredictor_parameters_{}_{}_{}_run{}.pt'.format(save_folder,dataset,variant,lr_value,run),map_location=torch.device(device)))
