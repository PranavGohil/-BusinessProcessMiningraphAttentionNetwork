# -*- coding: utf-8 -*-
"""EventQuartiles_TimePredictor_(GCN).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ogzP4c87PlV4hYmVZddqjreTbpN3xM89
...
for lr_run in range(lr_run, lr_run_end):
  ...
  for run in range(num_runs):
    model.load_state_dict(torch.load('D:\\GraphAnalytics\\GCN-ProcessPrediction-master\\python_files\\Results\\helpdesk\\TimestampPredictor_parameters_helpdesk_laplacianOnWeighted_0.0001_run0.pt'))
