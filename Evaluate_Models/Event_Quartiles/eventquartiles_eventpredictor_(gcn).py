# -*- coding: utf-8 -*-
"""EventQuartiles_EventPredictor_(GCN).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1_K7fpgzkK8xLTCA8t6h3S5CajhZjvk8_

<a href="https://colab.research.google.com/github/ishwarvenugopal/GCN-ProcessPrediction/blob/master/Evaluate_Models/Event_Quartiles/EventQuartiles_EventPredictor_(GCN).ipynb" target="_parent"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a>
...
for lr_run in range(lr_run, lr_run_end):
  ...
  for run in range(num_runs):
    model.load_state_dict(torch.load('D:\GraphAnalytics\GCN-ProcessPrediction-master\python_files\Results\helpdesk\EventPredictor_parameters_helpdesk_laplacianOnBinary_0.001_run0_GCNNNNNNNNN.pt'))
...
df.to_csv('EventQuartiles_Accuracy_{}_{}.csv'.format(dataset,variant),index=False)
df
